...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    private final List<Channel> mMyChannelItems;
    private final List<Channel> mOtherChannelItems;
    private final FinishEditListener mFinishEditListener;
    ...
    public ChannelAdapter(Context context, ItemTouchHelper helper,
                          List<Channel> myChannelItems, List<Channel> otherChannelItems,
                          FinishEditListener listener) {
        this.mInflater = LayoutInflater.from(context);
        this.mItemTouchHelper = helper;
        this.mMyChannelItems = myChannelItems;
        this.mOtherChannelItems = otherChannelItems;
        this.mFinishEditListener = listener;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_MY_CHANNEL_HEADER:
                ...
                return new MyChannelHeaderViewHolder(view);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            myHolder.textView.setText(mMyChannelItems.get(position - COUNT_PRE_MY_HEADER).name);
        } else if (holder instanceof OtherViewHolder) {
            String name = mOtherChannelItems.get(position - mMyChannelItems.size() - COUNT_PRE_OTHER_HEADER).name;
            ((OtherViewHolder) holder).textView.setText(name);
        }
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements OnDragVHListener {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            textView = (TextView) itemView.findViewById(R.id.my_channel_tv);
        }
    ...
    class MyChannelHeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyChannelHeaderViewHolder(View itemView) {
            super(itemView);
            finishTV = (TextView) itemView.findViewById(R.id.finish_tv);
            finishTV.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if(mFinishEditListener != null){
                        mFinishEditListener.onFinishEdit();
                    }
                }
            });
        }
